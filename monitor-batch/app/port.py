...
def data_list(_dict,_clockList,_divUnit):
    ...
    dataList=[data_query(querySQL.format(
        db,tb,logic,severity,y[0],y[1],_dict.get('filter')))/_divUnit for y in _clockList]
    return dataList
